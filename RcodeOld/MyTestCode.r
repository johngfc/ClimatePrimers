...
rGDP <-  setPostInputs(rGDP,list('DATASET_URI'='http://cida.usgs.gov/thredds/dodsC/prism',
                                        'TIME_START'='2000-01-01T00:00:00Z',
                                        'TIME_END'='2009-05-01T00:00:00Z'))



#rGDP <-  setPostInputs(rGDP,list('DATASET_URI'='http://esgdata1.nccs.nasa.gov/thredds/dodsC/bypass/NEX-DCP30/bcsd/rcp60/r1i1p1.ncml',
#                                        'TIME_START'='2009-01-01T00:00:00Z',
#                                        'TIME_END'='2012-05-01T00:00:00Z'))
