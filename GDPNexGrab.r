...
download.file(url=status.rGDP$URL,destfile="C:\\Users\\mallen\\Desktop\\Climate\\ClimateData\\rGDPTry.nc",mode="wb")
Clim<-open.ncdf("C:\\Users\\mallen\\Desktop\\Climate\\ClimateData\\rGDPTry.nc")
